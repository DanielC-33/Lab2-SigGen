...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    // Init
    CData/*7:0*/ __Vdly__sigdelay__DOT__address;
    CData/*7:0*/ __Vdlyvdim0__sigdelay__DOT__mic_ram__DOT__ram_array__v0;
    CData/*7:0*/ __Vdlyvval__sigdelay__DOT__mic_ram__DOT__ram_array__v0;
    CData/*0:0*/ __Vdlyvset__sigdelay__DOT__mic_ram__DOT__ram_array__v0;
    // Body
    __Vdly__sigdelay__DOT__address = vlSelf->sigdelay__DOT__address;
    __Vdlyvset__sigdelay__DOT__mic_ram__DOT__ram_array__v0 = 0U;
    __Vdly__sigdelay__DOT__address = ((IData)(vlSelf->rst)
                                       ? 0U : (0xffU 
                                               & ((IData)(1U) 
                                                  + (IData)(vlSelf->sigdelay__DOT__address))));
    if (vlSelf->rd) {
        vlSelf->delayed_signal = vlSelf->sigdelay__DOT__mic_ram__DOT__ram_array
            [(0xffU & (((IData)(vlSelf->sigdelay__DOT__address) 
                        - (IData)(vlSelf->offset)) 
                       - (IData)(1U)))];
    }
    if (vlSelf->wr) {
        __Vdlyvval__sigdelay__DOT__mic_ram__DOT__ram_array__v0 
            = vlSelf->mic_signal;
        __Vdlyvset__sigdelay__DOT__mic_ram__DOT__ram_array__v0 = 1U;
        __Vdlyvdim0__sigdelay__DOT__mic_ram__DOT__ram_array__v0 
            = vlSelf->sigdelay__DOT__address;
    }
    vlSelf->sigdelay__DOT__address = __Vdly__sigdelay__DOT__address;
    if (__Vdlyvset__sigdelay__DOT__mic_ram__DOT__ram_array__v0) {
        vlSelf->sigdelay__DOT__mic_ram__DOT__ram_array[__Vdlyvdim0__sigdelay__DOT__mic_ram__DOT__ram_array__v0] 
            = __Vdlyvval__sigdelay__DOT__mic_ram__DOT__ram_array__v0;
    }
}
